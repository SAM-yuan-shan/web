...
import { career } from '@/config/infoConfig'
              ...
              <a className="flex flex-col sm:flex-row sm:justify-between">
                <div className="flex max-w-2xl flex-col items-start">
                  <span className="flex flex-row items-center gap-2">
                    <div className="text-base font-semibold leading-6">{role.company}</div>
                ...
                <div className="flex flex-row gap-2 mt-0.5">
                  ...
                  <span className="text-sm leading-5 text-muted-foreground">
                    {role.end === 'Present' ? '现在' : role.end.split('-')[0]}
                  </span>
                </div>
              </a>
            </div>
